...
<!--                    <br />-->
                    ...
                    <h3 class="underline inline-block m-top-16">Titre professionnelle:</h3>
                    <a href="http://www.sophrologuebordeaux.fr/img/utcons.9698cf5f.jpg" target="_blank">
                        <img src="../../assets/RNCP.jpg" class="m-top-8" style="width: 200px; "/>
                    </a>
